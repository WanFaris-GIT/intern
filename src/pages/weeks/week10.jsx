...
function Week10() {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      if (!isPaused) setCurrentIndex((prevIndex) => (prevIndex + 1) % images.length);
    }, 5000);
    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-6" style={{ position: "relative", zIndex: 10 }}>
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-blue-700 dark:text-blue-700 mb-2">Week 10</h1>
          <p className={`text-lg mb-8 ${darkMode ? "text-gray-400" : "text-gray-600"}`}>08 March 2026 - 12 March 2026</p>
          ...
          <div className={`${darkMode ? "text-gray-200" : "text-gray-700"}`}>
            <p className="text-lg leading-relaxed">
              ...
              database management and monitored performance of client numbers.
            </p>
          </div>
        </div>
      </div>
