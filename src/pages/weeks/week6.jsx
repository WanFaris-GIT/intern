      ...
      <div className="max-w-6xl mx-auto px-6" style={{ position: "relative", zIndex: 10 }}>
        ...
        <div className={`relative max-w-4xl mx-auto px-12 md:px-24 py-8 md:py-16 backdrop-blur-xl border rounded-3xl shadow-2xl hover:shadow-xl transition duration-300 card-glow ${
          ...
          <p className={`text-lg mb-8 ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
            08 February 2026 - 12 February 2026
          </p>
          ...
          <div className={`${darkMode ? 'text-gray-200' : 'text-gray-700'}`}>
            <p className="text-lg leading-relaxed">
                During this week, I worked on recording client collection data and following up with unresponsive clients. 
                This task improved my communication skills and taught me how to interact professionally while ensuring all records 
                were accurate and up to date. In addition, I was also involved in meetings with the DCM department, which gave 
                me exposure to team discussions, planning, and better understanding of departmental workflows.
            </p>
          </div>
        </div>
      </div>
