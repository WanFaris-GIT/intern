    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-6" style={{ position: "relative", zIndex: 10 }}>
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-blue-700 dark:text-blue-700 mb-2">Week 6</h1>
          <p className={`text-lg mb-8 ${darkMode ? "text-gray-400" : "text-gray-600"}`}>08 February 2026 - 12 February 2026</p>
