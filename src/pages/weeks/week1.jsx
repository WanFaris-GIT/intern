  ...
  return (
    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-6" style={{ position: "relative", zIndex: 10 }}>
        ...
        {/* Glassmorphism Card — tambah relative */}
        <div className={`relative max-w-4xl mx-auto px-12 md:px-24 py-8 md:py-16 backdrop-blur-xl border rounded-3xl shadow-2xl hover:shadow-xl transition duration-300 card-glow ${
          ...
          <div className={`${darkMode ? 'text-gray-200' : 'text-gray-700'}`}>
            <p className="text-lg leading-relaxed">
              During Week 1, I was introduced to the company's workflow, systems, and responsibilities. I learned how to organize creative content materials systematically and understood the basic process of managing client data and WhatsApp blasting systems.
            </p>
          </div>
        </div>
      </div>
