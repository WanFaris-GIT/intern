      ...
      <div className="max-w-6xl mx-auto px-6" style={{ position: "relative", zIndex: 10 }}>
        ...
        <div className={`relative max-w-4xl mx-auto px-12 md:px-24 py-8 md:py-16 backdrop-blur-xl border rounded-3xl shadow-2xl hover:shadow-xl transition duration-300 card-glow ${
          ...
          <p className={`text-lg mb-8 ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
            04 January 2026 - 08 January 2026
          </p>
          ...
          <div className={`${darkMode ? 'text-gray-200' : 'text-gray-700'}`}>
            <p className="text-lg leading-relaxed">
                During the first week, I was introduced to the company&apos;s background, workflow, and digital marketing operations. 
                I learned the basic structure of handling client accounts and was exposed to tools used for WhatsApp blasting. 
                This week helped me adapt to the working environment and understand my responsibilities as an intern.
            </p>
          </div>
        </div>
      </div>
