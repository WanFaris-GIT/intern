      ...
      <div className="max-w-6xl mx-auto px-6" style={{ position: "relative", zIndex: 10 }}>
        ...
        >
          ...
          <div style={{ position: "absolute", top: "24px", right: "24px" }}>
            <button onClick={() => navigate("/week12")} aria-label="Next week" style={{
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-blue-700 dark:text-blue-700 mb-2">Week 11</h1>
          <p className={`text-lg mb-8 ${darkMode ? "text-gray-400" : "text-gray-600"}`}>15 March 2026 - 19 March 2026</p>
          ...
          <div className={`${darkMode ? "text-gray-200" : "text-gray-700"}`}>
            <p className="text-lg leading-relaxed">During Week 11, I carried out WhatsApp blasting tasks, managed client numbers, and monitored campaign effectiveness.</p>
          </div>
        </div>
      </div>
    </section>
