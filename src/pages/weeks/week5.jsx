...
function Week5() {
  ...
  const images = [
    "/images/TukarKlien.jpeg",
    "/images/ServerKT.jpeg",
    "/images/CaknaUmmah.png",
  ];
    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-6" style={{ position: "relative", zIndex: 10 }}>
        ...
        >
          ...
          {/* Header */}
          <h1 className="text-4xl md:text-5xl font-extrabold text-blue-700 dark:text-blue-700 mb-2">Week 5</h1>

          <p className={`text-lg mb-8 ${darkMode ? "text-gray-400" : "text-gray-600"}`}>
            01 February 2026 - 05 February 2026
          </p>
          ...
          <div className={`${darkMode ? "text-gray-200" : "text-gray-700"}`}>
            <p className="text-lg leading-relaxed">
              In the fifth week, I assisted in the transition of client management (PIC exchange). I handled the transfer of
              important information such as databases, contact numbers, emails, and system access. This experience taught me
              the importance of proper documentation and smooth communication during transitions.
            </p>
          </div>
        </div>
      </div>
