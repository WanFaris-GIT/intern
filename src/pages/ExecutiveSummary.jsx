      ...
      >
        ...
        >
          <div className="space-y-6">
            <p className={`leading-relaxed text-base first-letter:text-4xl first-letter:font-bold first-letter:text-blue-600 ${darkMode ? 'text-gray-200' : 'text-gray-700'}`}>
              After completing my Industrial Training at HIT Digital Marketing Sdn. Bhd. under the Database Customer Management (DCM) Department, I gained valuable exposure to the professional working environment, particularly in the field of digital marketing and customer database management. The experience provided meaningful opportunities to develop practical skills and a deeper understanding of how digital marketing operations are conducted in a real organizational setting. This achievement brought a sense of pride and appreciation for the knowledge and experience gained, which served as a strong foundation for future career development.
            </p>
            ...
            <p className={`leading-relaxed text-base first-letter:text-3xl first-letter:font-bold first-letter:text-blue-600 ${darkMode ? 'text-gray-200' : 'text-gray-700'}`}>
              In conclusion, the Industrial Training at HIT Digital Marketing Sdn. Bhd. was an important learning experience that contributed significantly to both my personal and professional development. The knowledge and skills gained throughout this period prepared me to face future challenges with greater confidence, while fostering a strong appreciation for teamwork, responsibility, and continuous learning in a professional environment.
            </p>
          </div>
        </div>
      </div>
